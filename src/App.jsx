    ...
    <>
        ...
        <div className="fullscreen-overlay">
          <div className="glass offline-card">
            ...
            <h3 style={{ fontSize: '2.5rem', marginBottom: '1.5rem', textShadow: '0 0 10px rgba(132, 204, 22, 0.5)' }}>
              🧬 {game.formatNumber(game.offlineGoldEarned)}
            </h3>
        ...
        <div className="fullscreen-overlay" onClick={() => setPickingSlot(null)}>
          <div className="odds-modal glass" onClick={e => e.stopPropagation()}>
            ...
            <div className="filter-bar">
              ...
              <div className="filter-group">
                {[['dps','🦠 Inercia'],['attackSpeed','⚡ Vel.'],['gold','💰 Biomasa'],['crit','🎯 Crítico']].map(([stat, label]) => (
                  <button key={stat}
          ...
          <div className="odds-modal glass" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              {fusionConfirmData.statWeights.map(({ stat, pct }) => {
                const statNames = { dps: '🦠 Inercia (DPS)', attackSpeed: '⚡ Vel. Ataque', gold: '💰 Biomasa', crit: '🎯 Prob. Crítico' };
                return (
        ...
        <div className="fullscreen-overlay" onClick={() => setStatsOpen(false)}>
          <div className="stats-panel glass" onClick={e => e.stopPropagation()}>
            ...
            <div className="stats-body">
              ...
              <div className="stats-section">
                <div className="stats-section-title">💰 Economía</div>
                <div className="stat-row">
      ...
      <div className="header glass">
        <div className="header-top-row">
          <div className="gold-display"><span>🧬</span> {game.formatNumber(game.gold)}</div>
      ...
      {/* ── Action Area ── */}
      <div className="action-area" onClick={onZoneTap}>
        {game.enemy.isBoss && (
          <>
                      ...
                      <div key={box.id} className="box-card" style={{ '--box-color': box.color, '--box-glow': box.glowColor }}>
                        ...
                        <div className="box-card-info" style={{ flex: 1 }}>
                          ...
                          <div style={{ fontSize: '0.7rem', color: 'var(--text-secondary)', marginTop: '0.3rem' }}>
                            🦠 {game.formatNumber(box.cost)} / caja
                          </div>
                        </div>
                      </div>
                    );
              ...
              <div className="cepa-detail-view">
                  ...
                  {Object.keys(bonuses).length > 0 && (
                    <div style={{ marginTop: '1rem', fontSize: '0.85rem', background: 'rgba(0,0,0,0.3)', padding: '0.8rem', borderRadius: '8px' }}>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem' }}>
                        ...
                        {bonuses.gold && <div title="Aumenta la ganancia global de biomasa al derrotar enemigos.">💰 Biomasa (Global): <strong style={{color:'#eab308'}}>+{Math.round(bonuses.gold * 100)}%</strong></div>}
                ...
                <div className="cepa-detail-actions">
                  <button className="upgrade-btn main-action-btn" disabled={!canAfford}
                    ...
                    {isUnlocked ? 'SOBRECARGA' : 'INCUBAR'}<br />🧬 {game.formatNumber(cost)}
                  </button>
                  {isUnlocked && (
                    ...
                    <div className="box-card-info" style={{ flex: 1 }}>
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                        ...
                        <div style={{ minWidth: '80px', textAlign: 'right' }}>
                          ...
                          <div style={{ color: canAfford ? 'var(--accent-cyan)' : '#ef4444', fontWeight: 'bold', fontSize: '0.9rem' }}>🧬 {game.formatNumber(cost)}</div>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="fullscreen-overlay" onClick={() => setShopOpen(false)}>
          <div className="stats-panel glass" onClick={e => e.stopPropagation()}>
            ...
            <div className="stats-body shop-modal">
              ...
              {/* Sección Biomasa */}
              <div className="shop-section">
                <div className="shop-section-title">🧬 Cajas de Biomasa</div>
                <div className="biomass-grid">
                  {[
                    { val: 1000000, price: '0.99€', img: '🧬' },
                    { val: 6000000, price: '4.99€', img: '🧪' },
                    { val: 15000000, price: '9.99€', img: '☣️' },
                    { val: 50000000, price: '24.99€', img: '🔋' },
                    { val: 150000000, price: '49.99€', img: '💎' },
                    { val: 500000000, price: '99.99€', img: '👑' }
                  ].map((p, i) => (
